...
def get_groups(dataset='NTU', CoM=21):
    ...
    if dataset == 'NTU':
        ...
        if CoM == 1:
            groups.append([1])
            groups.append([2,6,10,14,18])
            groups.append([3,7,11,15,19])
            groups.append([4,8,12,16,20])
            groups.append([5,9,13,17,21])
    
    elif dataset == 'CAD' or dataset == 'VOL':
        if CoM == 1:
            groups.append([1])
            groups.append([2,3])
            groups.append([4,5])
            groups.append([6,7])
            groups.append([8,9,12,13])
            groups.append([10,14,15,11])
            groups.append([16,17])
        ...
        if CoM == 1:
            ...
            groups.append([7])
            groups.append([6,9])
            groups.append([10,12,15,18])
            groups.append([11,13,16,19])
            groups.append([2,14,17,20])
            groups.append([3,4,5])
    
    elif dataset == 'Harper':
        if CoM == 1:
            groups.append([1])
            groups.append([2,14,18])
            groups.append([3,7,11,15,19])
            groups.append([4,6,8,10,12,16,20])
            groups.append([5,9,13,17,21])
